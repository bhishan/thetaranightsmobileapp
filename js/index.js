...
var app = {
  ...
  commentSubmit: function(name, email, comment, id_of_post){
      $.ajax({
        url: 'http://thetaranights.com/api/respond/submit_comment/?post_id=' + id_of_post + '&name=' + name + '&email=' +email + '&content=' + comment,
        type: 'POST',
        dataType: 'json'}); 
  ...
  blog: function(page){
    function getBlogs() {
     var dfd = $.Deferred();
      $.ajax({
        url: 'http://thetaranights.com/api/get_recent_posts/?page=' + page + '&count=8',
        type: 'GET',
        dataType: 'json',
...
category: function(slug, count){
  function getCategories() {
    var dfd = $.Deferred();
    $.ajax({
      url: 'http://thetaranights.com/?json=get_category_posts&slug=' + slug + '&page=' + count,
      type: 'GET',
      dataType: 'json',
      success: function(data){
        var source   = $("#blog-template").html();
...
catsingle: function() {
  ...
  portfolio: function(){
    $.ajax({
      url: 'http://thetaranights.com/?json=get_recent_posts&post_type=portfolio',
      type: 'GET',
      dataType: 'json',
      success: function(data){
